...
Product.create(name: 'Product 7', description: "Description 7", price: "#{rand(0..50)}", category: "Cat 7", store_id: 3)
Product.create(name: 'Product 8', description: "Description 8", price: "#{rand(0..50)}", category: "Cat 8", store_id: 3)
Product.create(name: 'Product 9', description: "Description 9", price: "#{rand(0..50)}", category: "Cat 9", store_id: 3)
Product.create(name: 'Product 10', description: "Description 10", price: "#{rand(0..50)}", category: "Cat 10", store_id: 3)